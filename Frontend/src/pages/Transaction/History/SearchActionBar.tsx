...
interface Props {
  ...
  handleTranfer: (event: MouseEvent<HTMLButtonElement>) => void;
  handleDeposit: (event: MouseEvent<HTMLButtonElement>) => void;
}
    ...
    <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
      ...
      <div className="flex">
        <button
          ...
          className="text-white flex mr-3 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
          type="button"
          onClick={handleTranfer}
        >
           <DynamicHeroIcon icon="CreditCardIcon" className="w-4 h-4 mr-2 mt-0.5" />
          Money Transfer
        </button>
        <button
          id="createProductButton"
        ...
        >
           <DynamicHeroIcon icon="CurrencyDollarIcon" className="w-4 h-4 mr-2 mt-0.5" />
          Deposit
        </button>
      </div>
    </div>
