          ...
          {data &&
            data.map((dataItem: any) => (
              ...
              >
                ...
                <td title={dataItem.sender_name} className="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                  {dataItem.sender_account_number}
                </td>
                <td  title={dataItem.recipient_name}  className="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                  {dataItem.recipient_account_number}
                </td>
                <td className="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                  {dataItem.currency}
                </td>
