...
import { ApiGetUserDetail, ApiPostDeposit } from "@/libs/Utils/ApiHelpers";
...
const FormDeposit: React.FC<Props> = ({
  isModalOpen,
  handleCloseModal,
  callBackRefresh,
}) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const { success, data, error } = await ApiPostDeposit(amount);
        ...
        <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
          <div className="relative bg-white rounded-lg shadow h-100 dark:bg-gray-800">
            <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
              <h3 className="text-xl font-semibold dark:text-white">Deposit</h3>
              <button
            ...
            <div className="p-6 mb-3 space-y-6 h-100">
              <form action="#">
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-12 sm:col-span-3">
                    ...
                    <p className="mt-5 text-xs border p-3 bg-gray-50 text-black rounded-lg">

                    Please be informed that all deposits require approval to ensure validation and security. Our team will review your deposit request and verify the transaction details before processing it. This approval process may take some time, and we appreciate your patience.
                    </p>
                  </div>
