...
import Routers from "@/libs/Utils/Routers";
function Sidebar() {
        ...
        >
                      ...
                      {item.children ? (
                        <div>
                          <button
                            ...
                            data-collapse-toggle={`dropdown-${item.path}`}
                          >
                            <DynamicHeroIcon
                              icon={item.icon ? item.icon.toString() : ""}
                          ...
                          <ul
                            ...
                            className={(pathname.includes(item.path)
                              ? ""
                              : "hidden ") +"py-2 space-y-2 pl-4"}
                          >
          ...
          <div className="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800 sidebar-bottom-menu">
            ...
            <a
              ...
              className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <DynamicHeroIcon icon="Cog8ToothIcon" className="h-6 w-6 " />
            </a>
            <div
              id="tooltip-settings"
              role="tooltip"
            ...
            <div
              ...
              style={{
                ...
                margin: 0,
                transform: "translate3d(183.5px, 1421px, 0px)",
              }}
            >
                  ...
                  >
                    <div className="inline-flex items-center">
                      ...
                      >
                        ...
                        <rect width="512" height="300" fill="#CE1126" />
                      </svg>
                      Indonesia
                    </div>
                  </a>
